...
FULL_KIDS_COMPANIES = {
    "RBLX": {
        "name": "רובלוקס 🎮",
        "desc": "פלטפורמה ענקית לבניית משחקים.",
        "products": "עולמות וירטואליים וכסף משחק (Robux).",
        "fun_fact": "בכל יום נכנסים למשחק יותר מ-60 מיליון ילדים!",
    ...
    "DIS": {
        "name": "דיסני 🎢",
        "desc": "חברת הבידור והסרטים הגדולה בעולם.",
        "products": "סרטי מארוול, פארקי שעשועים ובובות.",
        "fun_fact": "הדמות הראשונה שוולט דיסני צייר הייתה ארנב, לא עכבר!",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Disney_wordmark.svg/200px-Disney_wordmark.svg.png",
        "risk": 5
    },
    "MCD": {
        "name": "מקדונלד'ס 🍔",
        "desc": "רשת המסעדות המוכרת ביותר בעולם.",
        "products": "המבורגרים, צ'יפס וארוחות ילדים.",
        "fun_fact": "היא חברת הצעצועים הגדולה בעולם בזכות ההפתעות בארוחות!",
    ...
    "NKE": {
        "name": "נייקי 👟",
        "desc": "יצרנית בגדי ונעלי הספורט הגדולה בעולם.",
        "products": "נעלי כדורסל (כמו ג'ורדן) ובגדי ספורט.",
        "fun_fact": "סמל החברה (ה'סווש') עוצב על ידי סטודנטית שהרוויחה עליו רק 35 דולר!",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Logo_NIKE.svg/200px-Logo_NIKE.svg.png",
        "risk": 6
    },
    "KO": {
        "name": "קוקה-קולה 🥤",
        "desc": "המשקה המתוק הנמכר ביותר בהיסטוריה.",
        "products": "קוקה קולה, פאנטה וספרייט.",
        "fun_fact": "המתכון הסודי שמור בתוך כספת מיוחדת וענקית באטלנטה!",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Coca-Cola_logo.svg/200px-Coca-Cola_logo.svg.png",
        "risk": 2
    },
    "AAPL": {
        "name": "אפל 📱",
        "desc": "ענקית טכנולוגיה שממציאה מכשירים חכמים.",
        "products": "אייפון, אייפד ושעוני אפל.",
        "fun_fact": "המייסדים מכרו את המכונית שלהם רק כדי לקנות רכיבים למחשב הראשון!",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Apple_logo_black.svg/100px-Apple_logo_black.svg.png",
        "risk": 7
    },
    "MSFT": {
        "name": "מיקרוסופט 💻",
        "desc": "חברת תוכנה ומשחקים ענקית.",
        "products": "ווינדוס, קונסולת אקס-בוקס (Xbox) ומיינקראפט.",
        "fun_fact": "מקים החברה, ביל גייטס, התחיל לתכנת כשהיה רק בן 13!",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Microsoft_logo.svg/200px-Microsoft_logo.svg.png",
        "risk": 5
    },
    "SONY": {
        "name": "סוני 🕹️",
        "desc": "חברה יפנית שמייצרת אלקטרוניקה ומשחקים.",
        "products": "פלייסטיישן, טלוויזיות, וסרטי ספיידרמן.",
        "fun_fact": "הפלייסטיישן הראשון הומצא בכלל בגלל ויכוח בין סוני לחברת נינטנדו!",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Sony_logo.svg/200px-Sony_logo.svg.png",
        "risk": 6
    },
    "NFLX": {
        "name": "נטפליקס 🍿",
        "desc": "החברה שהמציאה את הצפייה הישירה בסדרות.",
        "products": "סרטים וסדרות דרך האינטרנט.",
        "fun_fact": "פעם, נטפליקס הייתה שולחת סרטים על דיסקים (DVD) לאנשים בדואר!",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Netflix_2015_logo.svg/200px-Netflix_2015_logo.svg.png",
        "risk": 8
    },
    "AMZN": {
        "name": "אמזון 📦",
        "desc": "החנות האינטרנטית הגדולה בעולם.",
        "products": "אתר קניות שמגיע עד הבית ועוזרים חכמים (אלקסה).",
        "fun_fact": "כשהאתר הוקם, הוא מכר רק סוג אחד של מוצרים: ספרים!",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Amazon_logo.svg/200px-Amazon_logo.svg.png",
        "risk": 6
    },
    "HSY": {
        "name": "הרשיז 🍫",
        "desc": "אחת מחברות השוקולד הגדולות באמריקה.",
        "products": "שוקולד, ריסס (Reese's) וסירופ לפנקייק.",
        "fun_fact": "בעיר שבה החברה נמצאת, אפילו פנסי הרחוב מעוצבים כמו נשיקות שוקולד!",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/The_Hershey_Company_logo.svg/200px-The_Hershey_Company_logo.svg.png",
        "risk": 3
    },
    "MAT": {
        "name": "מאטל 🏎️",
        "desc": "יצרנית הצעצועים הענקית.",
        "products": "ברבי, מכוניות הוט-ווילס (Hot Wheels) ומשחק הקלפים אונו.",
        "fun_fact": "בובת הברבי הראשונה בעולם עלתה רק 3 דולר!",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Mattel_logo.svg/200px-Mattel_logo.svg.png",
        "risk": 7
    }
}

FULL_BACKUP_DATA = {
    k: {"div": random.uniform(0, 4), "growth": random.uniform(-20, 50)}
    for k in FULL_KIDS_COMPANIES.keys()
}
...
# =================== הגדרות המשקיע (בתוך הדף — ללא סיידבר) ===================
st.markdown("<div class='settings-box'><h4>🕹️ איזה משקיע אתה? הזז את המדים כדי להתאים את הציונים אליך!</h4></div>", unsafe_allow_html=True)

col_s1, col_s2, col_s3 = st.columns(3)
with col_s1:
    st.markdown("**🚀 צמיחה מהירה**")
    w_growth = st.slider(" ", 0, 10, 5, key="w_growth")
with col_s2:
    st.markdown("**💰 דמי כיס (דיבידנד)**")
    w_dividend = st.slider("  ", 0, 10, 5, key="w_dividend")
with col_s3:
    st.markdown("**🎢 סיכון שאני מוכן לקחת**")
    w_risk = st.slider("   ", 1, 10, 5, key="w_risk")

# =================== פונקציות עזר ===================
def risk_color(r):
    return "#16a34a" if r <= 3 else "#d97706" if r <= 6 else "#dc2626"

def risk_label(r):
    return "נמוך" if r <= 3 else "בינוני" if r <= 6 else "גבוה"
    ...
    if len(rows) == 0:
        for ticker in tickers:
            ...
            rows.append({
                ...
                "products": d["products"], "fun_fact": d["fun_fact"], "image": d["image"],
                "risk": d["risk"],
                "div": round(FULL_BACKUP_DATA[ticker]["div"], 2),
                "growth": round(FULL_BACKUP_DATA[ticker]["growth"], 2),
                "is_dummy": True,
            })
...
with tab1:
    ...
    for _, row in df.iterrows():
        ...
        <tr>
          ...
          <td>{row['div']}%</td>
          <td style='color:{"#166534" if row["growth"]>=0 else "#991b1b"}; font-weight:bold;'>{g_sign}{row['growth']}%</td>
    ...
    with col3:
        ...
        g_sign   = "+" if sel["growth"] >= 0 else ""
        st.markdown(f"<div class='metric-box' style='background:{bg_col};'><b>צמיחה אחרונה</b><br><span style='font-size:24px;color:{text_col};font-weight:bold;'>{g_sign}{sel['growth']}%</span></div>", unsafe_allow_html=True)

    # --- מחשבון ---
    st.markdown("---")
    st.subheader("🧮 מחשבון השקעות — כמה יהיה לנו בעתיד?")
    ...
    st.write("נניח שנשקיע לפי התכנית שלנו, והחברה תגדל בשנה הקרובה בדיוק כמו שהיא גדלה בשנה שעברה. הנה התוצאה:")
...
with tab2:
    ...
    # קישור לסרטון: מהי כלכלה
    st.video("https://www.youtube.com/watch?v=qZtOtsSnE0Y")
    ...
    # קישור לסרטון: מה זה כסף
    st.video("https://www.youtube.com/watch?v=YhVwuJoY3ic")
    
    st.warning("### 💰 שלב 3 — איך מרוויחים מזה כסף?\n**1️⃣ צמיחה:** אם החברה מצליחה, כולם רוצים את החתיכות שלה. המחיר עולה ותוכלו למכור ברווח! 🤑\n**2️⃣ דיבידנד:** כשהחברה מרוויחה המון, היא מחלקת לשותפים מזומן ישר לחשבון! 💌")
    # קישור לסרטון: כלכלה לילדים
    st.video("https://www.youtube.com/watch?v=EULj7xJuaqk")
    ...
    def get_infinite_questions_pool():
        pool = [
            {
                ...
                "ok":  "🎉 מעולה! דיבידנד הוא כמו דמי כיס שהחברה מחלקת!",
                "bad": "❌ דיבידנד הוא כסף מזומן שחברה רווחית מחלקת למי שקנה את המניות שלה."
            },
            {
                "q": "מה בדרך כלל יותר בטוח?",
                "options": ["לקנות מניה של חברה אחת בלבד", "לקנות קרן סל שכוללת המון חברות"],
                "answer": "לקנות קרן סל שכוללת המון חברות",
                "ok":  "🎉 נכון! פיזור בין הרבה חברות = פחות סיכון!",
                "bad": "❌ כשקונים הרבה חברות יחד (קרן סל) הסיכון יורד."
            },
            {
                "q": "למה מומלץ לפזר את הכסף בין כמה חברות שונות?",
                "options": ["כי ככה זה נראה יותר יפה", "כי זה החוק בישראל", "כדי שאם חברה אחת תפסיד, האחרות יוכלו לאזן אותה", "אי אפשר לפזר את הכסף"],
                "answer": "כדי שאם חברה אחת תפסיד, האחרות יוכלו לאזן אותה",
                "ok":  "🎉 נכון! זה נקרא 'פיזור סיכונים'. לא שמים את כל הביצים בסל אחד!",
                "bad": "❌ אנחנו מפזרים כדי לא להיות תלויים רק בהצלחה של חברה אחת."
            },
            {
                "q": "מה עלול לקרות אם נקנה מניה והחברה תתחיל להפסיד הרבה כסף?",
                "options": ["ערך המניה עלול לרדת", "נצטרך לשלם להם קנס", "המניה תהפוך למטבע זהב", "לא קורה כלום"],
                "answer": "ערך המניה עלול לרדת",
                "ok":  "🎉 נכון. כשהחברה מפסידה, פחות אנשים רוצים אותה והמחיר יורד.",
                "bad": "❌ במצב כזה, אנשים ירצו למכור את המניה שלהם, וערך המניה ירד."
            },
            {
                "q": "האם בורסה היא כמו קסם שמתעשרים ממנו ביום אחד?",
                "options": ["כן, תמיד מרוויחים בתוך יום!", "לא, זה דורש סבלנות, למידה והשקעה לאורך שנים", "כן, מספיק ללחוץ על כפתור", "לא, אי אפשר להרוויח בבורסה בכלל"],
                "answer": "לא, זה דורש סבלנות, למידה והשקעה לאורך שנים",
                "ok":  "🎉 בדיוק! השקעה נכונה בבורסה היא כמו לשתול עץ — לוקח לו זמן לצמוח!",
                "bad": "❌ הבורסה היא לא קסם. צריך סבלנות והשקעה לאורך זמן."
            },
        ]
        ...
        for _ in range(25):
            ...
            opts      = [f"{div_money} ₪", f"{div_money + 10} ₪", f"{div_money * 10} ₪", f"{invest} ₪"]
            random.shuffle(opts)
            pool.append({
                "q":      f"השקעתם {invest} ₪ בחברה מעולה שמחלקת דיבידנד של {div_p}%. כמה דמי כיס תקבלו?",
                "options": opts,
                "answer": f"{div_money} ₪",
