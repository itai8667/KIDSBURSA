...
/* 1. מחזירים את האפליקציה לימין (הסיידבאר יחזור לצד ימין) */
.stApp {
...
/* 2. התיקון הקריטי לסלולר: כפתור הסגירה (X) של הסיידבאר!
זה מונע מהסיידבאר להיתקע פתוח בטלפון כשהופכים את המסך לעברית */
[data-testid="stSidebar"] button[kind="header"] {
    direction: ltr !important; 
}

/* 3. שמירה על הסליידרים כדי שהכפתור יזוז נכון ולא ישתגע */
...
# הכפתור ממוקם בחוץ כך שהוא בולט לעין
